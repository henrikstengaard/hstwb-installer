namespace HstWbInstaller.Core.Tests.InfoTests
{
    ...
    public static class NewIconSize1X1PixelsWith50ColorsTestHelper
    {
        public const int NumColors = 50;
        
        public const int Width = 1;
        public const int Height = 1;
        public static readonly int Depth = (int)Math.Ceiling(Math.Log(NumColors) / Math.Log(2));
        ...
        public static NewIcon NewIcon = new()
        {
            ...
            Palette = Enumerable.Range(1, NumColors).Select(_ => new byte[] { 255, 0, 0 }).ToArray(),
