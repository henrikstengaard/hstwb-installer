namespace HstWbInstaller.Core.IO.FastFileSystem
{
    ...
    {
        public static async Task<byte[]> BuildBlock(EntryBlock dirBlock, uint blockSize)
        {
            var blockStream =
                new MemoryStream(
            ...
            await blockStream.WriteStringWithLength(dirBlock.Comment, Constants.MAXCMMTLEN + 1);
            await blockStream.WriteBytes(new byte[91 - Constants.MAXCMMTLEN + 1]); // r5
