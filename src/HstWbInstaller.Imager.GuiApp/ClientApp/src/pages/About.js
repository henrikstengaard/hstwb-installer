...
export default function About() {
    ...
    return (
        <Box>
            ...
            <Typography sx={{ mt: 2 }}>
                HstWB Imager is created and maintained by Henrik Nørfjand Stengaard. To support future development and appreciate your use of HstWB Imager, please make a donation via <Link href="#" onClick={async (event) => openUrl(event, payPalDonateUrl)}>PayPal donate</Link>.
            </Typography>
            <Typography sx={{ mt: 2 }}>
